...
export function runGameLogic(
  ...
  const {
    ...
    makeFrenchFries,
    isMeatWithTomato,
    isCookedMeatForSandwich,
    isMeatSeasoned,
    makeMeatWithTomato,
    isCookedChoppedMeat,
    isPotatoSoupPrep,
    isPotatoMeatStewPrep,
    makePotatoMeatStew,
    isMeatStewNeedsPotatoes,
    isMeatStewNeedsCarrots,
    isMeatStewPrep,
    addMeatStewPotatoes,
    addMeatStewCarrots,
    makeSteakSandwich,
    isPlateFood,
    needsPineappleChopForOven,
    isOvenPlateInput,
    isBakedFood,
    foodLabel,
    bakeFoodFromInput,
    ...
    makePotSoupMix,
    isFinishedSoupPrep,
    isPotSoupSeasonedForMicrowave,
    isPotSoupReadyForMicrowave,
    isFinishedSoupComplete,
    heatPotSoup,
    soupLabel,
    makeBowlFlour,
    makeBowlDough,
